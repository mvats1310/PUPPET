...
{
    [Serializable]
    public class FollowJointTrajectoryGoalMsg : Message
    {
        public const string k_RosMessageName = "control_msgs/FollowJointTrajectoryGoal";
        ...
        public FollowJointTrajectoryGoalMsg()
        {
        ...
        public FollowJointTrajectoryGoalMsg(Trajectory.JointTrajectoryMsg trajectory, JointToleranceMsg[] path_tolerance, JointToleranceMsg[] goal_tolerance, DurationMsg goal_time_tolerance)
        {
        ...
        public static FollowJointTrajectoryGoalMsg Deserialize(MessageDeserializer deserializer) => new FollowJointTrajectoryGoalMsg(deserializer);

        private FollowJointTrajectoryGoalMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "FollowJointTrajectoryGoalMsg: " +
