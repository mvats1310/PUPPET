...
{
    [Serializable]
    public class FollowJointTrajectoryFeedbackMsg : Message
    {
        public const string k_RosMessageName = "control_msgs/FollowJointTrajectoryFeedback";
        ...
        public FollowJointTrajectoryFeedbackMsg()
        {
        ...
        public FollowJointTrajectoryFeedbackMsg(HeaderMsg header, string[] joint_names, Trajectory.JointTrajectoryPointMsg desired, Trajectory.JointTrajectoryPointMsg actual, Trajectory.JointTrajectoryPointMsg error)
        {
            this.header = header;
        ...
        public static FollowJointTrajectoryFeedbackMsg Deserialize(MessageDeserializer deserializer) => new FollowJointTrajectoryFeedbackMsg(deserializer);

        private FollowJointTrajectoryFeedbackMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "FollowJointTrajectoryFeedbackMsg: " +
