...
{
    [Serializable]
    public class PointHeadGoalMsg : Message
    {
        public const string k_RosMessageName = "control_msgs/PointHeadGoal";
        ...
        public PointHeadGoalMsg(Geometry.PointStampedMsg target, Geometry.Vector3Msg pointing_axis, string pointing_frame, DurationMsg min_duration, double max_velocity)
        {
            this.target = target;
        ...
        public static PointHeadGoalMsg Deserialize(MessageDeserializer deserializer) => new PointHeadGoalMsg(deserializer);

        private PointHeadGoalMsg(MessageDeserializer deserializer)
        {
