...
{
    [Serializable]
    public class GripperCommandFeedbackMsg : Message
    {
        public const string k_RosMessageName = "control_msgs/GripperCommandFeedback";
        ...
        public GripperCommandFeedbackMsg()
        {
            this.position = 0.0;
            this.effort = 0.0;
            this.stalled = false;
        ...
        public GripperCommandFeedbackMsg(double position, double effort, bool stalled, bool reached_goal)
        {
        ...
        public static GripperCommandFeedbackMsg Deserialize(MessageDeserializer deserializer) => new GripperCommandFeedbackMsg(deserializer);

        private GripperCommandFeedbackMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "GripperCommandFeedbackMsg: " +
