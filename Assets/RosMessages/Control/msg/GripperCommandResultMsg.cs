...
{
    [Serializable]
    public class GripperCommandResultMsg : Message
    {
        public const string k_RosMessageName = "control_msgs/GripperCommandResult";
        ...
        public GripperCommandResultMsg()
        {
            this.position = 0.0;
            this.effort = 0.0;
            this.stalled = false;
        ...
        public GripperCommandResultMsg(double position, double effort, bool stalled, bool reached_goal)
        {
        ...
        public static GripperCommandResultMsg Deserialize(MessageDeserializer deserializer) => new GripperCommandResultMsg(deserializer);

        private GripperCommandResultMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "GripperCommandResultMsg: " +
